...
from .maze_layout import get_level_map, get_moving_walls, update_moving_walls, get_portals
...
VISION_RADIUS = 1.75  # Define the vision radius in tiles
...
def run_level(music_start_time = 0):
    ...
    music_path = os.path.join("levels/level9/music.mp3")
    pygame.mixer.init()
